...
- Added a "Why I built this" founder section to index.html (#founder, "Our story" in nav): Nikieta's real story — parent frustrated by un-answerable childcare questions without tours, QA engineer who vets things professionally, ties into the "personally review every listing" trust model. First-name-only and no photo by her implicit privacy default; photo/full name are easy adds if she decides she wants them.
